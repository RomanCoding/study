            ...
            <div class="container">
                <div class="header__i">
                    ...
                    <div class="header-menu">
                        <a class="scroll_link step step1c" href="#">Введіть ваші дані</a>
                        <a class="scroll_link active step step2" href="#">Пройдіть тестування</a>
                        <a class="scroll_link step step3" href="#">Переходьте до навчання</a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="screen01__text02 wow1 fadeInUp" data-wow-delay=".1s">
                            Тривалість тестування 40 хвилин.<br/>
                            Ви можете пройти тест натиснувши на кнопку нижче.
                        </div>
                            <a href="#" onclick="startTest()"
                               class="screen01__btn wow1 fadeInUp" data-wow-delay=".05s">Пройти тест</a>
                        <div class="info">
                            Не можете пройти тест зараз?<br/>
                            Ми вислали лист з посиланням на тест на вказаний вами email.<br/>
                            Пройдіть тест у зручний для вас час.
                        </div>
                    </div>
                </div>
            </div>
    ...
    function startTest() {
        $.ajax({
            ...
            success: function(res) {
                if(res.success) {
                    window.location.href = '/ua/questions.php?hash=' + getHash();
                } else {
                    alert(res.error);
                }
            }
