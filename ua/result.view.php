            ...
            <div class="container">
                <div class="header__i">
                    ...
                    <div class="header-menu">
                        ...
                        <div class="step">&nbsp;</div>
                        <a class="scroll_link step step2c" href="#">Пройдіть тестування</a>
                        <div class="step">&nbsp;</div>
                        <a class="scroll_link active step step3" href="#">Переходьте до навчання</a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="screen01__text02 wow1 fadeInUp" data-wow-delay=".1s">
                            Рівень вашого англійської:
                            <p class="h4"><?= $level ?></p>
                            <br/>
                            Ви можете приступити до навчання на програмі
                            <br>
                            <a href="http://onlinelearn.study.ua/user/organization/1/self_registration/22081-MaJsC-2HyU2-urdHy"
                               class="screen01__btn wow1 fadeInUp" data-wow-delay=".05s">Почати навчання</a>
                        </div>
                    </div>
                </div>
            </div>
