                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="screen01__text02 wow1 fadeInUp" data-wow-delay=".1s">
                            Продолжительность тестирования 40 минут.<br/>
                            Вы можете пройти тест нажав на кнопку ниже.
                        </div>
                            <a href="#" onclick="startTest()"
                               class="screen01__btn wow1 fadeInUp" data-wow-delay=".05s">Пройти тест</a>
                        <div class="info">
                            Не можете пройти тест сейчас?<br/>
                            Мы выслали письмо со ссылкой на тест на указанный вами email.<br/>
                            Пройдите тест в удобное для вас время.
                        </div>
                    </div>
                </div>
            </div>
